  ...
  return (
    <>
      <StyledAppBar position="static">
        <Toolbar>
          ...
          >
            ...
            <h5>
              Get an optional viewing experience across all major devices like
              desktop and mobile. Streamlab is fully responsive, and the images,
              videos, text will scale down for smaller devices.
            </h5>
          </Typography>
        </Toolbar>
      </StyledAppBar>
      <iframe
        width="100%"
        height="600"
        src="https://www.youtube.com/embed/XK9zL0ze9O4?autoplay=1&mute=1&playsinline=1"
